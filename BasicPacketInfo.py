...
class BasicPacketInfo():
	def __init__(self,src,dst,srcPort,dstPort,protocol,timestamp, generator):
	...
	def setFlags(self, flagByte):   	
   	...
   	def printTcp(self):
   		...
   		print socket.inet_ntoa(self.getSrc()) + '  --> ' + socket.inet_ntoa(self.getDst())
...
'''tester = BasicPacketInfo('12','20',10,10,1,20,1)
print('Tester created!')
print tester.generateFlowId()
x = tester.getheaderPacket()
